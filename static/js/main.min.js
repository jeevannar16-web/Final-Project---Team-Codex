...
(function(){
  function badgeOnly() { return !document.getElementById('mini-cart-dropdown'); }
  ...
  function initMiniCart() {
    ...
    if (window.__miniCartInit) return;
    window.__miniCartInit = true;
